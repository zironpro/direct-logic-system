    ...
    <div className="grid grid-cols-1 gap-1 md:grid-cols-2 lg:grid-cols-3">
      <div className="min-h-0 rounded-2xl bg-card p-5 sm:p-6 lg:aspect-4/3">
        ...
        <p className="mt-3 text-muted-foreground text-sm sm:text-base">
          Stay secure with cutting-edge cybersecurity solutions. From firewalls to endpoint protection, we safeguard
          your business against threats, ensuring data integrity and peace of mind.
        </p>
      </div>
      ...
      <div className="flex min-h-[220px] flex-col items-center justify-center rounded-2xl bg-card p-5 sm:min-h-[240px] sm:p-6 lg:aspect-4/3">
        ...
        <h3 className="mt-4 mb-2 text-center font-semibold text-secondary text-xl sm:text-2xl">
          Dedicated Support Team
        </h3>
        <p className="text-balance text-center text-muted-foreground text-sm">
          Our certified IT experts are available 24/7, providing quick resolutions and ongoing guidance whenever you
          need it.
        </p>
      </div>
      ...
      <div className="relative overflow-hidden rounded-2xl bg-card p-5 pb-28 sm:p-6 sm:pb-32 md:col-span-2 lg:col-span-1 lg:aspect-4/3 lg:pb-6">
        <div className="relative z-10 flex flex-col gap-2">
          ...
          <p className="text-muted-foreground text-sm sm:text-base">
            Access a reliable network of global suppliers for electronics, IT equipment, and industrial solutions with
