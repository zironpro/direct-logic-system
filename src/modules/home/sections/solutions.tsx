...
export const Solutions = () => {
	return (
		<section aria-labelledby="solutions-heading" className="container max-w-7xl px-4 pb-16 md:px-6 md:pb-24 lg:px-8 lg:pb-32">
			...
			<p className="mx-auto mt-3 max-w-2xl text-center text-base text-muted-foreground md:text-lg">
				Direct Logic Systems LLC, based in Dubai, empowers businesses with innovative IT, trading, and digital marketing services.
				Our mission is to seamlessly integrate technology that drives your growth and security.
			</p>
			<div
				...
				{SOLUTIONS.map(({ id, title, description, icon: Icon }, i) => (
					<div
						className={cn(
							...
							i === 1 ? "shadow-primary/10 shadow-xl md:shadow-2xl md:shadow-primary/30" : "shadow-primary/10 shadow-xl",
