...
<Brand title="Western Digital" image="/images/products/wd.webp" logo="/images/brands/wd.svg">
  High-performance hard drives, SSDs, and enterprise storage solutions
</Brand>

<Brand title="Seagate" image="/images/products/seagate.webp" logo="/images/brands/seagate.svg">
  Reliable storage drives, enterprise solutions, and data center products
</Brand>

<Brand title="SanDisk" image="/images/products/sandisk.webp" logo="/images/brands/sandisk.svg">
  Flash memory, SSDs, and portable storage solutions
</Brand>

<Brand title="Toshiba" image="/images/products/toshiba.webp" logo="/images/brands/toshiba.svg">
  Advanced storage technology and enterprise-grade drives
</Brand>

<Brand title="Micron" image="/images/products/micron-storage.avif" logo="/images/brands/micron.svg">
  High-speed memory and storage solutions for demanding applications
</Brand>

### Memory Solutions
Advanced memory technology for optimal performance:

<Brand title="Crucial" image="/images/products/crucial.webp" logo="/images/brands/crucial.png">
  High-performance RAM modules and memory upgrades
</Brand>

<Brand title="Micron" image="/images/products/micron-memory.webp" logo="/images/brands/micron.svg">
  Enterprise memory solutions and advanced DRAM technology
</Brand>
